# konsultan_jamur_final_dengan_visual.py
...
# Mengatasi error _tkinter.TclError pada beberapa instalasi Python
import matplotlib
matplotlib.use('Agg')
...
# Simpan salinan data asli (teks) untuk ditampilkan nanti
df_asli = df.copy()

# Pra-pemrosesan: Mengubah semua kolom teks menjadi angka
label_encoders = {}
...
# <<< BAGIAN YANG HILANG, SEKARANG DITAMBAHKAN KEMBALI DI SINI >>>
...
# Menggunakan path yang robust untuk menyimpan file
...
# <<< AKHIR DARI BAGIAN YANG DITAMBAHKAN KEMBALI >>>
